...
private[spark] class LocalEndpoint(
  ...
  override def receive: PartialFunction[Any, Unit] = {
    ...
    case StatusUpdate(taskId, state, stateSpilled, runTime, serializedData) =>
      scheduler.statusUpdate(taskId, state, stateSpilled, runTime, serializedData)
...
private[spark] class LocalBackend(
  ...
  override def statusUpdate(
      ...
      runTime: Long, 
      serializedData: ByteBuffer) {
    localEndpoint.send(StatusUpdate(taskId, state, stateSpilled, runTime, serializedData))
  }

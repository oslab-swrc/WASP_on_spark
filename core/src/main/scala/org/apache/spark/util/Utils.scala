...
private[spark] case class CallSite(shortForm: String, longForm: String, methodName: String)

private[spark] object CallSite {
  val SHORT_FORM = "callSite.short"
  val LONG_FORM = "callSite.long"
  val METHOD_NAME = "callSite.method"
  val empty = CallSite("", "", "")
}
...
private[spark] object Utils extends Logging {
  ...
  def getCallSite(skipClass: String => Boolean = sparkInternalExclusionFunction): CallSite = {
    ...
    val methodName = s"$lastSparkMethod"

    CallSite(shortForm, longForm, methodName)
  }
  ...
  */
  ...
  def withDummyCallSite[T](sc: SparkContext)(body: => T): T = {
    ...
    val oldMethodCallSite = sc.getLocalProperty(CallSite.METHOD_NAME)
    try {
      sc.setLocalProperty(CallSite.SHORT_FORM, "")
      sc.setLocalProperty(CallSite.LONG_FORM, "")
      sc.setLocalProperty(CallSite.METHOD_NAME, "")
      body
    } finally {
      ...
      sc.setLocalProperty(CallSite.METHOD_NAME, oldMethodCallSite)
    }
  }
